...
public class TestFetchWeatherTask extends AndroidTestCase{
    ...
    static final String ADD_LOCATION_SETTING = "Kolkatta, IN";
    static final String ADD_LOCATION_CITY = "Kolkatta";
    static final double ADD_LOCATION_LAT = 88.3712;
    static final double ADD_LOCATION_LON = 22.5706;
